...
export function MiniRekentool() {
  ...
  return (
    <div ref={ref} className="relative mx-auto rounded-[2rem] overflow-hidden bg-white border border-slate-200/60 shadow-xl shadow-slate-200/40 p-8 md:p-12">
      ...
      <div className="grid md:grid-cols-2 gap-10 md:gap-16 items-center relative z-10">
        <div>
          <h3 className="text-3xl md:text-4xl font-bold tracking-tight text-slate-900 mb-4">De onzichtbare kosten</h3>
          ...
          <div className="space-y-6 mb-8 p-6 md:p-8 bg-slate-50 rounded-2xl border border-slate-100 shadow-sm">
            <div>
              <div className="flex justify-between items-baseline mb-4 text-sm font-semibold text-slate-700">
                <label htmlFor="mini-calls">Gemiste oproepen per week</label>
                <span className="text-blue-600 bg-blue-50 px-3 py-1 rounded-lg text-base shadow-sm border border-blue-100/50">{calls}</span>
              </div>
              <input
                type="range"
                id="mini-calls"
                ...
                className="w-full h-2.5 bg-slate-200 rounded-lg appearance-none cursor-pointer accent-blue-600 transition-all hover:bg-slate-300"
              />
            </div>
            ...
            <div className="pt-4 border-t border-slate-200/60">
              <div className="flex justify-between items-baseline mb-4 text-sm font-semibold text-slate-700">
                ...
                <span className="text-blue-600 bg-blue-50 px-3 py-1 rounded-lg text-base shadow-sm border border-blue-100/50">€{averagePrice}</span>
              </div>
              <input
                type="range"
                id="mini-price"
          ...
          <Link href="/rekentool" className="inline-flex items-center text-base font-semibold text-blue-600 hover:text-blue-700 transition-colors group">
            Open uitgebreide rekentool
            <span className="ml-2 group-hover:translate-x-1 transition-transform">&rarr;</span>
          </Link>
        </div>

        <div className="bg-slate-950 rounded-3xl p-8 md:p-12 border border-slate-800 text-center relative overflow-hidden flex flex-col justify-center min-h-[320px] shadow-2xl">
           ...
           <div className="relative z-10">
             <div className="text-sm font-semibold text-slate-400 mb-4 uppercase tracking-widest">Misgelopen omzet</div>
             <div className="text-6xl md:text-7xl font-bold tracking-tighter text-white mb-6 transition-transform">
               €<Counter value={monthlyLoss} />
             </div>
             <div className="inline-block bg-white/10 border border-white/10 text-slate-300 text-xs px-4 py-2 rounded-full font-medium">
